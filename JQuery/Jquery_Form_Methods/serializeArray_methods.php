                ...
                <div class="col-md-6">
                    <div class="input" id="input">
                        ...
                        <form action="" method="GET">
                            ...
                            <input type="text" name="firstname" class="form-control" value="Al Sakib" /><br/>
                            <label for="lastname" class="form-label">Last Name</label>
                            <input type="text" name="lastname" class="form-control" value="Ayon" /> <br/><br/>
