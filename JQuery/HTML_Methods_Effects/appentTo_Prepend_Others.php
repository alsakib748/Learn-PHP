...
<script>
    ...
    /// appendTo() function use 
    // $(document).ready(function(){
    //     $("#html-effects").click(function(){
    //         $("<b> Add to new content </b>").appendTo("p");
    //     });
    // });

    // $("#add-element").click(function(){
    //     let val = $("#getElement").val();
    //     $("<li>"+val+"</li>").appendTo("#unorder-list");
    // });

    /// prepend() function use 
    $(document).ready(function(){
        $("#html-effects").click(function(){
            $("p").prepend("<b>Add a New content</b> ");
        });

        $("#add-element").click(function(){
            let val = $("#getElement").val();
            $("#unorder-list").append("<li>"+val+" </li>");
        });
    });
</script>
