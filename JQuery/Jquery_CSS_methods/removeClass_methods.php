            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="input" id="input">
                        ...
                        <div id="div1" class="div11 div12 div13"><br/><br/>This is a first Div</div><br/>
                        <button class="btn btn-danger" id="btn2">AddClass To Made Design</button><br/><br/>
                        <div id="div2" class="div21 div22 div23 div24"><br/><br/>This is a second Div</div>
                    </div>
                    <div id="output">
                    ...
                    <script>
                        ...
                        $(document).ready(function(){
                            $("#btn1").click(function(){
                                $("#div1").removeClass("div11 div12 div13");
                            });

                            $("#btn2").click(function(){
                                $("#div2").removeClass("div21 div22 div23 div24");
                                // $("#div2").remove();
                            });
                        });
                    </script>
